...
- [Discord command access](discord-command-access.md) — all non-basic Discord commands require effective Administrator permission; Manage Server and recruiter roles do not bypass it
